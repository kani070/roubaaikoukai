// テキストと画像の切り替え
const scenes = [
    { text: "「寿子、今日は本当に楽しかったよ。君も楽しんでくれた？」", showImg: true,img: "img/shifuku1.PNG" },
	{ text: "寿子「ええ、若い頃を思い出したわ。でも…さすがに疲れたわね。」", showImg: true,img: "img/shifuku1.PNG" },
	{ text: "「今日一日あっという間に過ぎちゃったな…もっと一緒にいたいくらい。」", showImg: true,img: "img/shifuku1.PNG" },
	{ text: "寿子「ふふ、また会えるじゃない。こんな素敵な日を過ごせるのも、あなたのおかげね。」", showImg: true,img: "img/shifuku1.PNG" },
	{ text: "「もちろん、また一緒に出かけよう。今度はもっと楽しい場所に連れて行くよ。」", showImg: true,img: "img/shifuku1.PNG" },
];
