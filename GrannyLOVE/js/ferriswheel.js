// テキストと画像の切り替え
const scenes = [
    { text: "「観覧車はどう？のんびりできそうだね。」", showImg: true,img: "img/seifuku1.PNG",  backgroundChange: false, playSound: "audio/amusement.mp3" },
    { text: "寿子「そうね。」", showImg: true, img: "img/seifuku1.PNG",backgroundChange: false },
    { text: "「高いところからの景色、楽しみだな！」", showImg: true, img: "img/seifuku1.PNG", backgroundChange: false },
	{ text: "観覧車がゆっくりと回り始める。", showImg: false,  backgroundChange: true, playSound: "audio/odayaka.mp3" },
	{ text: "寿子と狭い観覧車のなかで二人きり……ドキドキ…", showImg: false,  backgroundChange: true },
	{ text: "「わぁ…見てよ、寿子！高層ビルがあんなに小さく」", showImg: false,  backgroundChange: true },
    { text: "「…寿子？」", showImg: false, backgroundChange:true },
	{ text: "「寝ちゃったの！？」", showImg: false, backgroundChange:true }, 
	 { text: "寿子「はっ！」", showImg: true,img: "img/seifuku1.PNG",  backgroundChange:true }, 
	{ text: "「アタシったら、眠っちゃってたみたい…。」",showImg: true,img: "img/seifuku1.PNG", showImg:false, backgroundChange:true },
];
